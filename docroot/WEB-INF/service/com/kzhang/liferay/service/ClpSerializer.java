...
import com.kzhang.liferay.model.FooClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"sample-ant-service-builder-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "sample-ant-service-builder-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.kzhang.liferay.model.impl.FooImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.kzhang.liferay.NoSuchFooException")) {
			return new com.kzhang.liferay.NoSuchFooException();
		}
