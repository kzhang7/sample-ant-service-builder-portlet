...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	public int compareTo(com.kzhang.liferay.model.Foo foo) {
	...
	public com.liferay.portal.model.CacheModel<com.kzhang.liferay.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	public com.kzhang.liferay.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	public com.kzhang.liferay.model.Foo toUnescapedModel() {
